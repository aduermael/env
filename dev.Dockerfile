...
ARG GROK_CLI_VERSION=0.2.121
ARG GROK_CLI_SHA256_AMD64=56025e812519a5ffc794cae5c67edb2d59e623aa92726177e88391840baaf17b
ARG GROK_CLI_SHA256_ARM64=31db4c579dff02d0915e6309cf4300436673055ccaf005dab28db1087639dd30
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
