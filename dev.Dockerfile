...
ARG CODEX_VERSION=rust-v0.155.1
...
ARG CODEX_CODE_MODE_HOST_SHA256_AMD64=9fd083743af55be818aceb351d371fb5136f5b6aa3938f167087373d27067b2d
ARG CODEX_CODE_MODE_HOST_SHA256_ARM64=516f2ed76d4ae96c2074d3c08f4576ed1bdc5c3a97e26734d7319de8b6861683
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
        amd64|x86_64) \
