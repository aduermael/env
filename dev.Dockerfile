...
ARG GROK_CLI_VERSION=1.0.41
ARG GROK_CLI_SHA256_AMD64=9ce03ed23e16ea01072b4496263d6213a27899e1e3e107f008d36edf82e70407
ARG GROK_CLI_SHA256_ARM64=7c0b8c973af6a78e2037f19ed93033471b8c5e722f9ff04b86b092e066e60d74
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
...
ARG CODEX_VERSION=rust-v0.156.1
...
ARG CODEX_CODE_MODE_HOST_SHA256_AMD64=a929daa9f6a0bddc00c0c9e6402df117b125acd96f9d554f6c99c32c7e66c608
ARG CODEX_CODE_MODE_HOST_SHA256_ARM64=40198138b03798ffa8c0da4c827a8ca5896774ea104b7110c2a2c0c7560cbe94
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
        amd64|x86_64) \
...
ARG CURSOR_CLI_VERSION=2026.09.18-9a7762b
ARG CURSOR_CLI_SHA256_AMD64=b1308f5a2fc05458b9d8966752986bb23a971bbcc67c842c1df94c4b8132bad9
ARG CURSOR_CLI_SHA256_ARM64=210d58f850f4616e4f265ff7006c558d5a2a008fce3e2bf8a0105c25ae3456a0
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
