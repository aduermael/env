...
ARG GROK_CLI_VERSION=0.2.118
ARG GROK_CLI_SHA256_AMD64=c192282e62abd24a9be64750363ff827d806ba613918399a8c69c815b1da08f6
ARG GROK_CLI_SHA256_ARM64=54010e335aace6b5dedd022539ece7bc83f38253e8636aaf0796562aeecb2e67
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
...
ARG CODEX_VERSION=rust-v0.146.1
ARG CODEX_SHA256_AMD64=f558105aec12bf6fb33570793adfc089f8b41dc32aced60b8b4fba9b451824ac
ARG CODEX_SHA256_ARM64=05de65ee7b6bd02038e720cc313941d5ec6794718e4261bd28fd83b93fe34d43
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
