...
ARG GROK_CLI_VERSION=0.2.99
ARG GROK_CLI_SHA256_AMD64=9fccba400d3808ec34a991892096b34c6f5846b2b118d355001601fd5428445c
ARG GROK_CLI_SHA256_ARM64=b7c1a41cf7fe9ab0a3dd56e801e6b819c4f3f933dca8a068864899d94221cd40
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
