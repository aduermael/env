...
ARG GROK_CLI_SHA256_AMD64=4e0738d3b5550f3c842bc0ae69f468815c6329c008a110d0c27a694dc3401135
ARG GROK_CLI_SHA256_ARM64=edae20e92a0a33fedec1aa3488f3e3808d8c4ca2128fc8f313fbd818e3e95f5f
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
...
ARG CODEX_VERSION=rust-v0.144.1
