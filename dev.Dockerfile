...
ARG GROK_CLI_VERSION=1.0.27
ARG GROK_CLI_SHA256_AMD64=d987e1316ac3504330387bc6229c052da03734dcb402f53d5736f7635bc175c4
ARG GROK_CLI_SHA256_ARM64=a34ce9243334dbd6a4924ced39826f9536a4e7cbba940339276cc5fab905763e
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
