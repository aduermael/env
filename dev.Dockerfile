...
ARG GROK_CLI_VERSION=0.2.82
ARG GROK_CLI_SHA256_AMD64=c74faf275141e16548802418ebf10763947ebaa00f2427bb80f022aba63688fe
ARG GROK_CLI_SHA256_ARM64=b4727c600786d64a3efb19f73a6c8b951b075b35d6fa7ca9519a089411507a58
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
...
ARG CODEX_SHA256_AMD64=d9dc731dc66e227b175b13c071be9ea126cc7672fcac8a87823da50b0d2b2ffe
ARG CODEX_SHA256_ARM64=daec4cb18f3ad3e541e8986763e73019b3ddb726d1f8692e50ea5fa988c09d78
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
