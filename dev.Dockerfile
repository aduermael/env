...
ARG GROK_CLI_VERSION=0.2.120
ARG GROK_CLI_SHA256_AMD64=2e252ab7d9727bad7bd371e1315d2b2de61444d6a62978347e347f52a9180980
ARG GROK_CLI_SHA256_ARM64=d4af276619c1b67d3903012acecd6b0e4a8a3f773a2398002d694068937cdc4a
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
