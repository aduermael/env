...
ARG GROK_CLI_VERSION=1.0.35
ARG GROK_CLI_SHA256_AMD64=f57df130e95a230d444933596f6530738d891ae470b7b7a45e304919d71b1cc4
ARG GROK_CLI_SHA256_ARM64=9f347a46bb25e1eaf303f5d9cf03494b0d40fd437e8d28dad2ce784fd1a21ceb
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
...
ARG CODEX_CODE_MODE_HOST_SHA256_AMD64=a68df7cca23c6da7cde175677df7de61c73a234add1333a1254b86d641af01f7
ARG CODEX_CODE_MODE_HOST_SHA256_ARM64=20aefa302c2022b496e32911bf954a5f76c7fd749c6bdb9fbd711e32b66dcbfa
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
        amd64|x86_64) \
...
ARG CURSOR_CLI_VERSION=2026.09.10-fd3934a
ARG CURSOR_CLI_SHA256_AMD64=27997c8391ad853a5a732b1845db8ef82a8ba6afb0f7829cc739464f8966e96e
ARG CURSOR_CLI_SHA256_ARM64=e0494438b01c37bc34848491d1f3478ef469494c56caf020de11796d146db64a
RUN set -eux; \
    image_arch="${TARGETARCH:-$(dpkg --print-architecture)}"; \
    case "${image_arch}" in \
